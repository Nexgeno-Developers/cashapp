...
<main class="main">
			...
			<div class="row">
				<div class="col-md-12">
				    ...
				    <ul>
						...
						<li><p><strong>Redemption:</strong> Both plans require the customer to make a purchase or take delivery of the jewellery within a certain period after the completion of the payment term. Golden Fortune requires redemption within 400 days, while Golden Treasure requires redemption before 400 days.</p></li>
 ...
 -->
				...
				<div class="row">
					<div class="col-md-12">						
						<h4 class="text-center">GOLDEN FORTUNE PLAN</h4>
						<br>
					</div>
					...
					<div class="col-md-12">
						...
						<ol>
							<li><p>The monthly payment amount is not subject to change once it has been fixed at the time of enrolment, and the customer shall make the payment of the same amount as the monthly amount, every month for a period of eleven months from the enrolment date.</p></li>
